...
## Research Rules
* As a part of your research, you may *not* make any changes to files unless explicitly request to do so by the user.
...
* If you find an existing RESEARCH.md file, ask the user what they would like you to do with the existing file *before* writing your research. You must, at least, offer the user three options:
